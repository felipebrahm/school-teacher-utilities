...
var _jsCookie = __webpack_require__(327);

var _jsCookie2 = _interopRequireDefault(_jsCookie);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var COOKIE_GROUPS_NUMBER = 'group-generator-groups-number';
var COOKIE_NAMES = 'group-generator-names';

var readAndSetDefaultValuesFromCookie = function readAndSetDefaultValuesFromCookie() {
  var groupsNumber = _jsCookie2.default.get(COOKIE_GROUPS_NUMBER);
  if (groupsNumber && groupsNumber >= 1) {
    $('#form-group-generator-groups-number').val(groupNumber);
  }

  var names = _jsCookie2.default.getJSON(COOKIE_NAMES);
  if (names && names.length > 0) {
    $('#form-group-generator-names').val(names.join('\n'));
  }
};

var randomizeArrayInPlace = function randomizeArrayInPlace(arr) {
  if (arr.length <= 1) {
    return arr;
  }
...
var getNamesFromTextArea = function getNamesFromTextArea() {
  return ($('#form-group-generator-names').val() || '').trim().split('\n');
};

var getGroupsNumber = function getGroupsNumber() {
...
$(window).ready(function () {
  ...
  $('#form-group-generator').submit(function (e) {
    e.preventDefault();

    var numberOfGroups = getGroupsNumber();
    ...
    var namesByLine = getNamesFromTextArea();
    ...
    var groups = [];
    var assignToGroupNumber = 0;

    namesByLine.forEach(function (line) {
    ...
    var $results = $('#random-generated-groups-results');
    $results.empty();
    ...
    if ($('#form-group-generator-save-cookie').prop('checked')) {
      _jsCookie2.default.set(COOKIE_GROUPS_NUMBER, getGroupsNumber(), { expires: 365 });
      _jsCookie2.default.set(COOKIE_NAMES, getNamesFromTextArea(), { expires: 365 });
    } else {
      _jsCookie2.default.remove(COOKIE_GROUPS_NUMBER);
      _jsCookie2.default.remove(COOKIE_NAMES);
    }
  });
});
